...
enum
{
	...
	COLLISION_FLAG_BULLET_AGAINST = COLLISION_FLAG_GROUND | COLLISION_FLAG_WHEEL | COLLISION_FLAG_CHASSIS | COLLISION_FLAG_DRIVABLE_OBSTACLE | COLLISION_FLAG_SHIELD_POWERUP,
