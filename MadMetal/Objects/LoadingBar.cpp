...
LoadingBar::LoadingBar(long id, Audioable *aable, Physicable *pable, Animatable *anable, Renderable *rable) : TestObject(id, aable, pable, anable, rable, NULL)
{
	...
	completeBar = new TestObject(id+1, audioable, physicable, animatable, renderable, NULL);
}
